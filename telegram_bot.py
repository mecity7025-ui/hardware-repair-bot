        ...
        "steps": {
            ...
            3: {
                "text": (
                    ...
                    "Does the microphone work correctly after reseating the connectors?"
                ),
                "yes": "mc_s3_yes",
                "no": 4,
            },
...
def main() -> None:
    ...
    app.add_handler(CallbackQueryHandler(handle_callback, pattern=r"^(g|bl|bd|nc|ns|dp|tw|mc|sp):"))
